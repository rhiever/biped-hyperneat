...
Network *Genome::genesis(int id, Network *cppn)
{
	...
	for(curnode = nodes.begin(); curnode != nodes.end(); ++curnode)
	{
		...
		double inputs[7] = {(*curnode)->x_sub_pos, (*curnode)->y_sub_pos, (*curnode)->z_sub_pos, // Node's position
